...
import { colorBlack, colorGreen, useMeemTheme } from '../Styles/MeemTheme'
				...
				<div className={meemTheme.backgroundMeem}>
					...
					{!isLoading && !agreement?.name && (
						<>
							...
							<Center>
								<Text>
									Sorry, we were unable to find that
									community. Check your spelling and try
									again.
								</Text>
							</Center>
							<Space h={256} />
							...
							<Container>
								...
								<Center>
									<Text
										...
										color={colorBlack}
									>
										Please connect at least one account
										below.
									</Text>
								</Center>
								<Space h={24} />
								<Center>
									<Text
										...
										color={colorBlack}
									>
										You’ll be able to connect additional
										accounts later.
									</Text>
								</Center>
								<Space h={48} />
