...
import { ClarityLinkExtensionSettings } from '../../../../components/Extensions/ClarityLink/ClarityLinkExtensionSettings'
			...
			<Head>
				<title>
					{agreement === undefined || agreement.isError
						? 'Not found'
						: `${agreement.responseBody.Agreements[0].name} | Clarity Settings | Meem`}
				</title>
				<meta
					name="title"
					content={
