...
import { SlikSafeLinkExtensionSettings } from '../../../../components/Extensions/SlikSafeLink/SlikSafeLinkExtensionSettings'
			...
			<Head>
				<title>
					{agreement === undefined || agreement.isError
						? 'Not found'
						: `${agreement.responseBody.Agreements[0].name} | SlikSafe Settings | Meem`}
				</title>
				<meta
					name="title"
					content={
