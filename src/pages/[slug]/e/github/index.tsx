...
import { GitHubLinkExtensionSettings } from '../../../../components/Extensions/GitHubLink/GitHubLinkExtensionSettings'
			...
			<Head>
				<title>
					{agreement === undefined || agreement.isError
						? 'Not found'
						: `${agreement.responseBody.Agreements[0].name} | GitHub Settings | Meem`}
				</title>
				<meta
					name="title"
					content={
