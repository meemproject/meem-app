...
import { AndroidLinkExtensionSettings } from '../../../../components/Extensions/AndroidLink/AndroidLinkExtensionSettings'
			...
			<Head>
				<title>
					{agreement === undefined || agreement.isError
						? 'Not found'
						: `${agreement.responseBody.Agreements[0].name} | Android Settings | Meem`}
				</title>
				<meta
					name="title"
					content={
