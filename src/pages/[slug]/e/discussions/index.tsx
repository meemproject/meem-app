...
import { DiscussionHome } from '../../../../components/Extensions/Discussions/DiscussionHome'
...
const DiscussionsIndexPage: NextPage<IProps> = ({ agreementName }) => {
...
export default DiscussionsIndexPage
