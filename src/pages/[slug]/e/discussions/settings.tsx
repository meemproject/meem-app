...
import { DiscussionSettings } from '../../../../components/Extensions/Discussions/DiscussionSettings'
...
const DiscussionSettingsPage: NextPage<IProps> = ({ agreement }) => {
	return (
		<>
			<Head>
				<title>
					{agreement === undefined || agreement.isError
						? 'Not found'
						: `${agreement.responseBody.Agreements[0].name} | Discussion Settings | Meem`}
				</title>
				<meta
					name="title"
					content={
