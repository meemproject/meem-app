...
import { GatherTownLinkExtensionSettings } from '../../../../components/Extensions/GatherTownLink/GatherTownLinkExtensionSettings'
...
const AgreementExampleExtensionSettingsPage: NextPage<IProps> = ({
	agreement
}) => {
	...
	return (
		<>
			<Head>
				<title>
					{agreement === undefined || agreement.isError
						? 'Not found'
						: `${agreement.responseBody.Agreements[0].name} | Gather Town Settings | Meem`}
				</title>
				<meta
					name="title"
					content={
			...
			<AgreementProvider slug={agreementSlug}>
				<GatherTownLinkExtensionSettings />
			</AgreementProvider>
			<Space h={64} />
			<MeemFooter />
		</>
...
export default AgreementExampleExtensionSettingsPage
