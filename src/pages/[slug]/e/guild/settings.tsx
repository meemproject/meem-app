...
import { GuildExtensionSettings } from '../../../../components/Extensions/Guild/GuildExtensionSettings'
...
const AgreementGuildExtensionSettingsPage: NextPage<IProps> = ({
	agreement
}) => {
...
export default AgreementGuildExtensionSettingsPage
