...
import { GnosisLinkExtensionSettings } from '../../../../components/Extensions/GnosisLink/GnosisLinkExtensionSettings'
			...
			<Head>
				<title>
					{agreement === undefined || agreement.isError
						? 'Not found'
						: `${agreement.responseBody.Agreements[0].name} | Gnosis Settings | Meem`}
				</title>
				<meta
					name="title"
					content={
