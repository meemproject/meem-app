...
import { OpenSeaLinkExtensionSettings } from '../../../../components/Extensions/OpenSeaLink/OpenSeaLinkExtensionSettings'
			...
			<Head>
				<title>
					{agreement === undefined || agreement.isError
						? 'Not found'
						: `${agreement.responseBody.Agreements[0].name} | OpenSea Settings | Meem`}
				</title>
				<meta
					name="title"
					content={
