...
import { ParagraphLinkExtensionSettings } from '../../../../components/Extensions/ParagraphLink/ParagraphLinkExtensionSettings'
	...
	return (
		<>
			<Head>
				<title>
					{agreement === undefined || agreement.isError
						? 'Not found'
						: `${agreement.responseBody.Agreements[0].name} | Paragraph Settings | Meem`}
				</title>
				<meta
					name="title"
					content={
			...
			<AgreementProvider slug={agreementSlug}>
				<ParagraphLinkExtensionSettings />
			</AgreementProvider>
			<Space h={64} />
			<MeemFooter />
		</>
