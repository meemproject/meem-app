...
import { EtsyLinkExtensionSettings } from '../../../../components/Extensions/EtsyLink/EtsyLinkExtensionSettings'
			...
			<Head>
				<title>
					{agreement === undefined || agreement.isError
						? 'Not found'
						: `${agreement.responseBody.Agreements[0].name} | Etsy Settings | Meem`}
				</title>
				<meta
					name="title"
					content={
