...
import { MycoLinkExtensionSettings } from '../../../../components/Extensions/MycoLink/MycoLinkExtensionSettings'
			...
			<Head>
				<title>
					{agreement === undefined || agreement.isError
						? 'Not found'
						: `${agreement.responseBody.Agreements[0].name} | Myco Settings | Meem`}
				</title>
				<meta
					name="title"
					content={
