...
import { LinkedInLinkExtensionSettings } from '../../../../components/Extensions/LinkedInLink/LinkedInLinkExtensionSettings'
			...
			<Head>
				<title>
					{agreement === undefined || agreement.isError
						? 'Not found'
						: `${agreement.responseBody.Agreements[0].name} | LinkedIn Settings | Meem`}
				</title>
				<meta
					name="title"
					content={
