...
import { SlackLinkExtensionSettings } from '../../../../components/Extensions/SlackLink/SlackLinkExtensionSettings'
			...
			<Head>
				<title>
					{agreement === undefined || agreement.isError
						? 'Not found'
						: `${agreement.responseBody.Agreements[0].name} | Slack Settings | Meem`}
				</title>
				<meta
					name="title"
					content={
