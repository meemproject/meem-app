...
import { IOSLinkExtensionSettings } from '../../../../components/Extensions/IOSLink/IOSLinkExtensionSettings'
			...
			<Head>
				<title>
					{agreement === undefined || agreement.isError
						? 'Not found'
						: `${agreement.responseBody.Agreements[0].name} | iOS Settings | Meem`}
				</title>
				<meta
					name="title"
					content={
