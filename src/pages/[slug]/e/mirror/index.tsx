...
import { MirrorLinkExtensionSettings } from '../../../../components/Extensions/MirrorLink/MirrorLinkExtensionSettings'
			...
			<Head>
				<title>
					{agreement === undefined || agreement.isError
						? 'Not found'
						: `${agreement.responseBody.Agreements[0].name} | Mirror Settings | Meem`}
				</title>
				<meta
					name="title"
					content={
