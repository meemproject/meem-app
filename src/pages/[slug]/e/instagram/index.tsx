...
import { InstagramLinkExtensionSettings } from '../../../../components/Extensions/InstagramLink/InstagramLinkExtensionSettings'
...
const AgreementExampleExtensionSettingsPage: NextPage<IProps> = ({
	...
	return (
		<>
			<Head>
				<title>
					{agreement === undefined || agreement.isError
						? 'Not found'
						: `${agreement.responseBody.Agreements[0].name} | Instagram Settings | Meem`}
				</title>
				<meta
					name="title"
					content={
			...
			<InstagramLinkExtensionSettings />
			<Space h={64} />
			<MeemFooter />
		</>
	)
