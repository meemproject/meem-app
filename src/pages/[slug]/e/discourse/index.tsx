...
import { DiscourseLinkExtensionSettings } from '../../../../components/Extensions/DiscourseLink/DiscourseLinkExtensionSettings'
...
const AgreementExampleExtensionSettingsPage: NextPage<IProps> = ({
	...
	return (
		<>
			<Head>
				<title>
					{agreement === undefined || agreement.isError
						? 'Not found'
						: `${agreement.responseBody.Agreements[0].name} | Discourse Settings | Meem`}
				</title>
				<meta
					name="title"
					content={
			...
			<DiscourseLinkExtensionSettings />
			<Space h={64} />
			<MeemFooter />
		</>
	)
