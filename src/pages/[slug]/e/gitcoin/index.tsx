...
import { GitcoinLinkExtensionSettings } from '../../../../components/Extensions/GitcoinLink/GitcoinLinkExtensionSettings'
			...
			<Head>
				<title>
					{agreement === undefined || agreement.isError
						? 'Not found'
						: `${agreement.responseBody.Agreements[0].name} | Gitcoin Settings | Meem`}
				</title>
				<meta
					name="title"
					content={
